...
export function FinalResultsHero({
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 text-typ-display font-bold tracking-tight text-foreground">{headline}</p>
      {subline ? <p className="mt-2 text-typ-body text-muted-foreground">{subline}</p> : null}
    </div>
  );
}
