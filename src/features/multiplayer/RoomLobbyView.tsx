...
import { FooterIconSlotButton, SecondaryFooterButton } from "@/components/game/GameFooterButtons";
            ...
            >
              ...
              <ul className="divide-y divide-border px-3 py-1">
                {lobby.players
                  ...
                  .map((player) => (
                    <li className="flex items-center gap-2 py-2 text-typ-ui" key={player.id}>
                      {player.ready ? (
                        <IconCheck aria-hidden className="size-4 shrink-0 text-emerald-600" />
                      ) : (
                        <span aria-hidden className="inline-block size-4 shrink-0" />
