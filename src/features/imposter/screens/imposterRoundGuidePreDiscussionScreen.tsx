    ...
    content: (
      ...
      >
        ...
        <p className={`mt-4 ${IMPOSTER_NOTICE_CLASS}`}>
          After voting is settled, tap below before anyone reads the phone again for the reveal.
        </p>
      </GamePanel>
    ),
    actions: <PrimaryFooterButton label="Vote done" onClick={() => controller.goGuideWarning()} />,
  };
}
