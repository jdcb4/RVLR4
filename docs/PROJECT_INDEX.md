...
- `src/features/whowhatwhere` — Who What Where: pass-and-play UI + `useGameController` (`WwwLandingScreen`, `WwwReviewTeamsScreen`, …); networked shell at `multiplayer/WhoWhatWhereMultiplayerView.tsx`.
